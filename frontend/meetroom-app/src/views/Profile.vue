...
<template>
	<div class="p-4 space-y-6">
		...
		<div
			...
			class="p-4 space-y-2 bg-soft-bg rounded-2xl shadow-neumorphism"
		>
			<h3 class="px-4 text-sm font-semibold text-gray-500">Admin Panel</h3>
			<RouterLink
				to="/admin/rooms"
			...
			<RouterLink
				...
				active-class="font-semibold text-blue-600"
			>
				<BookmarkSquareIcon class="w-6 h-6 mr-3" />
