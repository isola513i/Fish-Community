  ...
  <div>
    <div class="p-4 space-y-6">
      ...
      <div>
        ...
        <div
          v-if="isLoading && allRooms.length === 0"
        ...
        <div v-else>
          ...
          <div v-else class="space-y-4" :class="{ 'opacity-70': isLoading }">
            <div
            ...
            <div
              v-if="availableRooms.length === 0 && !isLoading"
